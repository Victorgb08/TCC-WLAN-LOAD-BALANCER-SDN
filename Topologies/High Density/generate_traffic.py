...
N_HOSTS = 18  # Número total de estações
...
high_traffic = range(1, 7)  # Estações 1 a 6 (tráfego alto)
medium_traffic = range(7, 13)  # Estações 7 a 12 (tráfego médio)
low_traffic = range(13, 19)  # Estações 13 a 18 (tráfego baixo)
