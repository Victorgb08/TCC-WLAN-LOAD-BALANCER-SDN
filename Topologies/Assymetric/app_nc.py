...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def monitor(self):
        ...
        for item in self.pubsub.listen():
            ...
            try:
                with open("nc_statistics.json", "r") as f:
            ...
            with open("nc_statistics.json", "w") as f:
    ...
    def get_possible_handover(self, oaps, uaps):
        ...
        for oap in oaps:
            for station in oap['stations_associated']:
                ...
                if 'aps' not in station_info:
                    print(f"Estação {station} não possui informações de APs disponíveis.")
                    continue
    
                station_aps = station_info['aps']
